...
// Inlined helpers from liveblocks-core
function freeze<T>(value: T): T {
  return process.env.NODE_ENV === "production" ? value : Object.freeze(value);
}
...
function compactObject<O extends Record<string, unknown>>(obj: O): O {
  const newObj = { ...obj };
