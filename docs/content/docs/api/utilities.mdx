...
<DecoderSig
  ...
  type="string"
  source="strings.ts#L113-L120"
/>

<Since version="2.9.0-pre.2" />

Takes any string decoder and rejects values that don't match the given size
constraints. Use this to add length validation to any string-based decoder.
