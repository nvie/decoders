...
<DecoderSig name="decimal" type="string" source="strings.ts#L151-L155" />
...
<DecoderSig name="hexadecimal" type="string" source="strings.ts#L157-L163" />
...
<DecoderSig name="numeric" type="number" source="strings.ts#L165-L170" />
...
<DecoderSig name="uuid" type="string" source="strings.ts#L123-L131" />
...
<DecoderSig name="uuidv1" type="string" source="strings.ts#L133-L140" />
...
<DecoderSig name="uuidv4" type="string" source="strings.ts#L142-L149" />
...
Also works with [arrays](/docs/api/arrays#limiting-array-sizes) and [sets](/docs/api/sets-and-maps#limiting-set-sizes).
