...
Like [`string`](#string), but will reject the empty string or strings containing only whitespace.
...
<DecoderSig name="startsWith" params="prefix: P" type="`${P}${string}`" source="strings.ts#L39-L47" />
...
<DecoderSig name="endsWith" params="suffix: S" type="`${string}${S}`" source="strings.ts#L49-L57" />
...
alphabet, use [`regex()`](#regex) instead.
