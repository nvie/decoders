...
<Sig
  ...
  params="blob: unknown"
  returnType="T"
  source="core/Decoder.ts#L216-L223"
/>
...
<Sig
  ...
  source="core/Decoder.ts#L225-L225"
/>
...
<Sig
  ...
  source="core/Decoder.ts#L206-L214"
/>
...
<Sig
  ...
  source="core/Decoder.ts#L232-L240"
/>
...
<Sig
  ...
  source="core/Decoder.ts#L242-L257"
/>
...
<Sig
  ...
  source="core/Decoder.ts#L259-L265"
/>
...
<Sig
  ...
  returnType="Decoder<T>"
  source="core/Decoder.ts#L308-L326"
/>
...
<Sig
  ...
  returnType="Decoder<T>"
  source="core/Decoder.ts#L328-L346"
/>
...
<Sig
  ...
  returnType="Decoder<V>"
  source="core/Decoder.ts#L267-L286"
/>

Low-level method to send decoded output into an acceptance function. Prefer
[`.transform()`][], [`.refine()`][], or [`.pipe()`][] in most cases.

Passing a decoder directly, as in `.chain(decoder)`, is deprecated since 2.11. Use
`.pipe(decoder)` instead, which does the same thing.
...
<Sig
  ...
  returnType="Decoder<V>"
  source="core/Decoder.ts#L288-L306"
/>
...
<DecoderPlayground
  decoder="string.transform(s => s.split(',').map(Number)).pipe(array(natural))"
