...
| ---------------------------------------------- | ---------------- | -------------------- |
| [`.verify()`](/docs/api/Decoder#decoderverify) | `T`              | Throws an error      |
| [`.value()`](/docs/api/Decoder#decodervalue)   | `T \| undefined` | Returns `undefined`  |
| [`.decode()`](/docs/api/Decoder#decoderdecode) | `Result<T>`      | Returns error result |
